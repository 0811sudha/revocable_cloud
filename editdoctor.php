...
?>
            ...
            <table class="center_tab" style="float:left;">
                ...
                <tbody>
                    <tr>
                        ...
                        <th>Qualification</th>
                        <td><!--input type="text" name="qual" required value="<?php echo $row['qual'];?>"-->
		<select name="qual">
		...
		<option value="BDS">BDS</option>
                    ...
                    <tr>
                        ...
                        <td><!--input type="text" name="special" required value="<?php echo $row['special'];?>"-->
		<select name="special">
...
<div style="float:right;"><img src="img/im3.jpg" style="width:400px;"></div>
        </form>
<?php
} else {
    extract($_POST);
