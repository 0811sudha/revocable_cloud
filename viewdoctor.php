...
echo "<div class='scrolldiv'><table class='report_tab' style='float:none;margin:auto;min-width:700px;'><thead><tr><th colspan='12'>DOCTORS LIST<tr><th>Name<th>Gender<th>Address<th>City<th>Mobile<th>Email<th>Qual<th>Special<th>CertNo<th>Expr<th>DOB<th>Task</thead><tbody>";
...
echo "<div style='text-align:center;margin-top:20px;'><img src='img/im3.jpg' style='width:400px;'></div>";
